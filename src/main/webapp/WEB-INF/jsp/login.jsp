    ...
    <div class="container">
        ...
        <sec:authorize access="isAnonymous()">
            <div class="pt-4">
                ...
                <button type="submit" class="btn btn-lg btn-primary" onclick="login('user@ok.kz','password')">
                    <spring:message code="app.login"/> User
                </button>
                <button type="submit" class="btn btn-lg btn-primary" onclick="login('admin@ok.kz','admin')">
        ...
        <div class="lead py-4">Стек технологий: <br>
            ...
            <a href="http://spring.io/blog/2014/05/07/preview-spring-security-test-method-security">Spring Security</a>,
            ...
            <a href="http://www.postgresql.com">PostgreSQL</a>,
